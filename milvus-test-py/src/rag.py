"""rag.py - 基于 Milvus 日记数据的 RAG 示例"""
import asyncio

from milvus_utils import DIARY_COLLECTION_NAME, create_chat_model, create_embeddings, create_milvus_client, ensure_diary_collection, format_search_results, load_collection
